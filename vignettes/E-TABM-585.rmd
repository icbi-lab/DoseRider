...
dose_rider_results <- DoseRiderParallel(se = se, gmt = gmt_p_data, 
                                           ...
                                           clusterResults = F, FilterPathway = TRUE,
                                           pca_threshold = 0.65)
...
ggsave(plotFile2, plot = p2, width = plot_width, height = plot_height, units = "px", dpi = 300) 
...
ggsave(plotFile3, plot = p3,  width = plot_width+1000, height = plot_height, units = "px", dpi = 300) 
...
ggsave(plotFile4, plot = p4,  width = plot_width, height = plot_height, units = "px", dpi = 300) 
...
ggsave(plotFile5, plot = p5,  width = plot_width, height = plot_height, units = "px", dpi = 300) 
...
jpeg(file=plotFile6,  width = plot_width, height = plot_height, units = "px", dpi = 300)
plot(p6)
dev.off()
...
ggsave(plotFile7, plot = p7, width = plot_width, height = plot_height, units = "px", dpi = 300)
```
