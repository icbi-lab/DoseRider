...
dose_rider_results <- DoseRiderParallel(se = filter_bpaf_data, gmt = gmt_p_data, 
                                          ...
                                          clusterResults = T, FilterPathway = T)
...
p4 <- plot_gene_random_effect_relationship(dose_rider_results, "MENSE_HYPOXIA_UP")
...
jpeg(file=plotFile1, width = PLOT_WIDTH - 1000, height = PLOT_HEIGHT - 1000, units = "px")
...
ggsave(plotFile3, plot = p3, width = plot_width, height = plot_height, units = "px", dpi = 600)

ggsave(plotFile4, plot = p4, width = PLOT_WIDTH, height = PLOT_HEIGHT, units = "px", dpi = 600)

ggsave(plotFile5, plot = p5, width = PLOT_WIDTH + 1500, height = PLOT_HEIGHT + 1500, units = "px", dpi = 600)

jpeg(file=plotFile6, width = PLOT_WIDTH - 1000, height = PLOT_HEIGHT - 1000, units = "px")
