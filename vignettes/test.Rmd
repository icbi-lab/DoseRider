...
dose_rider_results_filter <- filter_DoseRider(dose_rider_results, model_type = "all", threshold = 0.1)
bmd_bounds_df <- compute_bmd_bounds_parallel(dose_rider_results = dose_rider_results_filter, dose_col = "Dose", sample_col = "sample", covariates = c(), omic = "rnaseq", n_bootstrap = 50, num_cores = 20)
```
